...
use enumy::enums_structs_io::{OptInterpolacja, OptRozdzielczościObrazów};
...
use enumy::enums_structs_io::OptFormatyKoloruObrazuTga;
        ...
        for fdgfshd in bit_depth {
            ...
            let (final_img, nazwa_bd,color_type,szer,wys) = match fdgfshd {
                OptFormatyKoloruObrazuTga::Szary8 =>{
                        ...
                        (res.into_raw(), "_g", image::ExtendedColorType::L8, width,height)
                    },
                ...
                OptFormatyKoloruObrazuTga::TrueColor24 => {
                    ...
                    // }
                    let (width,height) = res.dimensions();
                    (res.into_raw(), "_tc24", image::ExtendedColorType::Rgb8, width,height)
                },
                ...
                OptFormatyKoloruObrazuTga::TrueColorA32 => {
                    ...
                    let (width,height) = res.dimensions();
                    (res.into_raw(), "_tc32", image::ExtendedColorType::Rgba8, width, height)
                },
            };
            aktualizuj_postep(&obecna_operacja, &procent_progress, metryka_operacji, &mut tx).await;
