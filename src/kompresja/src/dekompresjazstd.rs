...
use zstd::*;
// use enumy::enums_structs_io::ProcesStatus;
...
pub async fn dekompresujsuj(
    ...
    let _ = tx
        .send(LogTxDoDekompresjiPliku::StatusDekompresjaPlikówDekompresja { pamięć: None })
        .await;
    ...
    // 4. Pętla przetwarzania (StatusDekompresjaPlikówDekompresja)
    ...
    loop {
        ...
        // dlatego często wysyła się po prostu etap "StatusDekompresjaPlikówDekompresja..."
    ...
    println!(
        "StatusDekompresjaPlikówDekompresja {} zakończona.",
        nazwa_pliku
    );
    Ok(())
}
