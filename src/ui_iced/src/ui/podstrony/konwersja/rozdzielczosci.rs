    ...
    Column::new().padding(10)
        .push(
            Row::new()
                ...
                .push(btn_rozdzielczosci(Rozdzielczości::R128, jezyk, if dane.opcje_rozdzielczości.contains(&Rozdzielczości::R128){&BtnState::Active}else{&BtnState::Disabled}, kolor, temat))
                // .spacing(10)
        )
        .push(
            Row::new()
                ...
                .push(btn_rozdzielczosci(Rozdzielczości::R2k, jezyk, if dane.opcje_rozdzielczości.contains(&Rozdzielczości::R2k){&BtnState::Processing}else{&BtnState::Disabled}, kolor, temat))
                // .spacing(10)
        )
        .push(
            Row::new()
                ...
                .push(btn_rozdzielczosci(Rozdzielczości::R16k, jezyk, if dane.opcje_rozdzielczości.contains(&Rozdzielczości::R16k){&BtnState::Active}else{&BtnState::Disabled}, kolor, temat))
                // .spacing(10)
        )
        .push(
            Row::new()
                // .padding(10)
                .push(btn_rozdzielczosci(Rozdzielczości::Oryginalna, jezyk, if dane.opcje_rozdzielczości.contains(&Rozdzielczości::Oryginalna){&BtnState::Processing}else{&BtnState::Disabled}, kolor, temat))
                // .spacing(10)
        )
            // .spacing(10)
}