    ...
    pub fn update(&mut self, message: Message) -> Task<Message> {
        ...
        match message {
            ...
            Message::ZdjeciaEdycjaZmianaKolorJpg(wybrany_bit_depth) => {
                match wybrany_bit_depth {
                    OptFormatyKoloruObrazOgólny::L8 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany_bw =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany_bw
                    }
                    OptFormatyKoloruObrazOgólny::B8 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany_rgb =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany_rgb
                    }
                    _ => {}
                }
                // 1. Pobieramy referencję do pierwszego elementu (mutowalną)
                if let Some(OptRozszerzeniaPlikówZdjęciowych::Jpg { bit_depth, .. }) = self
                    .dane_temp_do_zbiorowe_przetwarzanie_zdjęć
                    .rozszerzenia_plików_zdjęciowych
                    .get_mut(0)
                {
                    // if bit_depth.contains(&wybrany_bit_depth) && !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany_rgb{}
                    match wybrany_bit_depth {
                        OptFormatyKoloruObrazOgólny::L8 => {
                            // Jeśli zawiera L8 i bool jest false -> USUŃ
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany_bw {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::L8);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::L8) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::L8);
                            }
                        }
                        OptFormatyKoloruObrazOgólny::B8 => {
                            // Analogiczna logika dla B8
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany_rgb {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::B8);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::B8) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::B8);
                            }
                        }
                        _ => {}
                    }
            ...
            Message::ZdjeciaEdycjaZmianaWybranyJpg => {
                self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany =
                    !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany;
            }
            Message::ZdjeciaEdycjaZmianaKompresjaWartoscFF(xianciantsu) => {
                if let Some(OptRozszerzeniaPlikówZdjęciowych::Ff { metoda_kompresji }) = self
                    .dane_temp_do_zbiorowe_przetwarzanie_zdjęć
                    .rozszerzenia_plików_zdjęciowych
                    .get_mut(4)
                {
                    // Zamiast patrzeć na booleany, patrzymy co tam już jest i tylko zmieniamy cyferkę
                    *metoda_kompresji = match *metoda_kompresji {
                        OptMetodaKompresjiZdjecia::Zstd(_) => {
                            OptMetodaKompresjiZdjecia::Zstd(xianciantsu)
                        }
                        OptMetodaKompresjiZdjecia::Bzip2(_) => {
                            OptMetodaKompresjiZdjecia::Bzip2(xianciantsu)
                        }
                        OptMetodaKompresjiZdjecia::Xz(_) => {
                            OptMetodaKompresjiZdjecia::Xz(xianciantsu)
                        }
                        OptMetodaKompresjiZdjecia::Brak => OptMetodaKompresjiZdjecia::Brak,
                    };
                }
            }
            Message::ZdjeciaEdycjaZmianaKompresjaFF(metoda) => {
                match metoda {
                    OptMetodaKompresjiZdjecia::Brak => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_brak = true;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_zstd = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_bzip2 = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_xz = false;
                    }
                    OptMetodaKompresjiZdjecia::Zstd(_) => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_brak = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_zstd = true;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_bzip2 = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_xz = false;
                    }
                    OptMetodaKompresjiZdjecia::Bzip2(_) => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_brak = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_zstd = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_bzip2 = true;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_xz = false;
                    }
                    OptMetodaKompresjiZdjecia::Xz(_) => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_brak = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_zstd = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_bzip2 = false;
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_kompresja_xz = true;
                    }
                }
            ...
            Message::ZdjeciaEdycjaZmianaWybranyFF => {
                self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_wybrany =
                    !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_ff_wybrany;
            }
            Message::ZdjeciaEdycjaZmianaWybranyTga => {
                self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany =
                    !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany;
            }
            Message::ZdjeciaEdycjaZmianaProgresJpg => {
                    ...
                    .get_mut(0)
                {
                    *progresywny = !*progresywny;
                    self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_progres = *progresywny;
                }
            }
            ...
            //     if let Some(rozszerzenia_plików_zdjęciowych::Png { filtr_alfa, .. }) = self.dane_temp_do_zbiorowe_przetwarzanie_zdjęć.rozszerzenia_plików_zdjęciowych.iter_mut().find(|r| matches!(r, rozszerzenia_plików_zdjęciowych::Png { .. })) {
            //         *filtr_alfa = !*filtr_alfa;
            //         self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_alpha = *filtr_alfa;
            //         println!("{:?}", self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_alpha)
            //     }
            // },
            //usuwanie z vec przed wyslaniem do fn ;)
            // // Klonujemy dane, żeby oryginał w UI został nienaruszony
            // let mut dane_do_obrobki = self.dane_temp_do_zbiorowe_przetwarzanie_zdjęć.clone();
            //
            // // Usuwamy z kopii to, czego użytkownik nie zaznaczył w toggle'ach
            // dane_do_obrobki.rozszerzenia_plików_zdjęciowych.retain(|opt| {
            // match opt.rozszerzenie {
            // rozszerzenia_plików_zdjęciowych::Jpg { .. } => self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_jpg_wybrany,
            // rozszerzenia_plików_zdjęciowych::Png { .. } => self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrany,
            // _ => true,
            // }
            // });
            //
            ...
            Message::WysylkaDanychDoObrobkiZdjec => {
                let mut dane_do_obrobki = self.dane_temp_do_zbiorowe_przetwarzanie_zdjęć.clone();
                self.checker_bool_status_zbiorowe_przetwarzanie_zdjęć = true;
                ...
                dane_do_obrobki
                    ...
                    .retain(|opt| match opt {
                        ...
                        OptRozszerzeniaPlikówZdjęciowych::Png { .. } => {
                            self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrany
                        }
                        OptRozszerzeniaPlikówZdjęciowych::Webp { .. } => {
                            self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_webp_wybrany
                        }
                        ...
                        OptRozszerzeniaPlikówZdjęciowych::Qoi { .. } => {
                            self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany
                        }
                    });
                dbg!(
            ...
            //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_alpha = !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_alpha
            // },
            Message::ZdjeciaEdycjaZmianaKolorPng(indeks, wartosc) => {
                ...
                self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_alpha_kolor_16b =
                    self.dane_temp_do_zbiorowe_przetwarzanie_zdjęć.alfa_rgb;
            }
            Message::ZdjeciaEdycjaZmianaBitDepthPng(wybrany_bit_depth) => {
                // Zakładamy, że PNG jest pod indeksem 1 w wektorze
                match wybrany_bit_depth {
                    OptFormatyKoloruObrazOgólny::L8 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l8bit =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l8bit;
                    }
                    OptFormatyKoloruObrazOgólny::L8a => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l8bita =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l8bita;
                    }
                    OptFormatyKoloruObrazOgólny::B8 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_8bit =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_8bit;
                    }
                    OptFormatyKoloruObrazOgólny::B8a => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_8bita =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_8bita;
                    }
                    OptFormatyKoloruObrazOgólny::L16 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l16bit =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l16bit;
                    }
                    OptFormatyKoloruObrazOgólny::L16a => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l16bita =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l16bita;
                    }
                    OptFormatyKoloruObrazOgólny::B16 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_16bit =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_16bit;
                    }
                    OptFormatyKoloruObrazOgólny::B16a => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_16bita =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_16bita;
                    }
                    OptFormatyKoloruObrazOgólny::B32 | OptFormatyKoloruObrazOgólny::B32a => {
                        // Tutaj pusto, zgodnie z Twoim wcześniejszym założeniem dla 32-bit
                    }
                }
                if let Some(OptRozszerzeniaPlikówZdjęciowych::Png { bit_depth, .. }) = self
                    .dane_temp_do_zbiorowe_przetwarzanie_zdjęć
                    .rozszerzenia_plików_zdjęciowych
                    .get_mut(1)
                {
                    ...
                    match wybrany_bit_depth {
                        // OptFormatyKoloruObrazOgólny::B8=> {
                        //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_8bit = true;
                        //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_16bit = false;
                        //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_8bita = false;
                        //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_16bita = false;
                        //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l8bit = false;
                        //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l16bit = false;
                        //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l8bita = false;
                        //     self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l16bita = false;
                        // },
                        OptFormatyKoloruObrazOgólny::B8 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_8bit {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::B8);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::B8) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::B8);
                            }
                        ...
                        OptFormatyKoloruObrazOgólny::B16 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_16bit {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::B16);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::B16) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::B16);
                            }
                        }
                        OptFormatyKoloruObrazOgólny::B8a => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_8bita {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::B8a);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::B8a) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::B8a);
                            }
                        }
                        OptFormatyKoloruObrazOgólny::B16a => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_16bita {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::B16a);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::B16a) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::B16a);
                            }
                        }
                        OptFormatyKoloruObrazOgólny::L8 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l8bit {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::L8);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::L8) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::L8);
                            }
                        ...
                        OptFormatyKoloruObrazOgólny::L8a => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l8bita {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::L8a);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::L8a) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::L8a);
                            }
                        }
                        OptFormatyKoloruObrazOgólny::L16 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l16bit {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::L16);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::L16) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::L16);
                            }
                        }
                        OptFormatyKoloruObrazOgólny::L16a => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_png_wybrane_l16bita {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::L16a);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::L16a) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::L16a);
                            }
                        }
                        _ => {}
                    }
            ...
            Message::ZdjeciaEdycjaZmianaLosslessWebp => {
                ...
                {
                    *lossless = !*lossless;
                    self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_webp_lossless = *lossless;
                }
            }
            ...
            Message::ZdjeciaEdycjaZmianaKolorWebp(wybrany_bit_depth) => {
                match wybrany_bit_depth {
                    OptFormatyKoloruObrazOgólny::B8a => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_webp_wybrany_alpha =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_webp_wybrany_alpha
                    }
                    OptFormatyKoloruObrazOgólny::B8 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_webp_wybrany_rgb =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_webp_wybrany_rgb
                    }
                    _ => {}
                }
                // 1. Pobieramy referencję do pierwszego elementu (mutowalną)
                if let Some(OptRozszerzeniaPlikówZdjęciowych::Webp { bit_depth, .. }) = self
                    .dane_temp_do_zbiorowe_przetwarzanie_zdjęć
                    .rozszerzenia_plików_zdjęciowych
                    .get_mut(2)
                {
                    ...
                    match wybrany_bit_depth {
                        OptFormatyKoloruObrazOgólny::B8 => {
                            // Jeśli zawiera L8 i bool jest false -> USUŃ
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_webp_wybrany_rgb {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::B8);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::B8) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::B8);
                            }
                        ...
                        OptFormatyKoloruObrazOgólny::B8a => {
                            // Analogiczna logika dla B8
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_webp_wybrany_alpha {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazOgólny::B8a);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazOgólny::B8a) {
                                bit_depth.push(OptFormatyKoloruObrazOgólny::B8a);
                            }
            ...
            Message::ZdjeciaEdycjaZmianaBitDepthTga(wybrany_bit_depth) => {
                ...
                match wybrany_bit_depth {
                    OptFormatyKoloruObrazuTga::Szary8 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_szary =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_szary;
                    }

                    OptFormatyKoloruObrazuTga::HighColor16 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_16b =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_16b;
                    }
                    OptFormatyKoloruObrazuTga::TrueColor24 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_24b =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_24b;
                    }
                    OptFormatyKoloruObrazuTga::TrueColorA32 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_32b =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_32b;
                    }
                }
                    ...
                    .get_mut(3)
                {
                    ...
                    match wybrany_bit_depth {
                        OptFormatyKoloruObrazuTga::Szary8 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_szary {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazuTga::Szary8);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazuTga::Szary8) {
                                bit_depth.push(OptFormatyKoloruObrazuTga::Szary8);
                            }
                        }
                        OptFormatyKoloruObrazuTga::HighColor16 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_16b {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazuTga::HighColor16);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazuTga::HighColor16) {
                                bit_depth.push(OptFormatyKoloruObrazuTga::HighColor16);
                            }
                        }
                        OptFormatyKoloruObrazuTga::TrueColor24 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_24b {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazuTga::TrueColor24);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazuTga::TrueColor24) {
                                bit_depth.push(OptFormatyKoloruObrazuTga::TrueColor24);
                            }
                        }
                        OptFormatyKoloruObrazuTga::TrueColorA32 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_tga_wybrany_32b {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazuTga::TrueColorA32);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazuTga::TrueColorA32)
                            {
                                bit_depth.push(OptFormatyKoloruObrazuTga::TrueColorA32);
                            }
                        }
                    }
                }
            }
            Message::ZdjeciaEdycjaZmianaWybranyQoi => {
                self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany =
                    !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany;
            }
            Message::ZdjeciaEdycjaZmianaBitDepthQoi(wybrany_bit_depth) => {
                match wybrany_bit_depth {
                    OptFormatyKoloruObrazuQoi::Color24 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany_24b =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany_24b;
                    }

                    OptFormatyKoloruObrazuQoi::ColorA32 => {
                        self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany_32b =
                            !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany_32b;
                    }
                }
                    ...
                    .get_mut(5)
                {
                    ...
                    match wybrany_bit_depth {
                        OptFormatyKoloruObrazuQoi::Color24 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany_24b {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazuQoi::Color24);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazuQoi::Color24) {
                                bit_depth.push(OptFormatyKoloruObrazuQoi::Color24);
                            }
                        }
                        OptFormatyKoloruObrazuQoi::ColorA32 => {
                            if !self.checker_do_zbiorowe_przetwarzanie_zdjęć.zbiorowe_przetwarzanie_zdjec_rozszerzenie_qoi_wybrany_32b {
                                bit_depth.retain(|x| x != &OptFormatyKoloruObrazuQoi::ColorA32);
                            } else if !bit_depth.contains(&OptFormatyKoloruObrazuQoi::ColorA32) {
                                bit_depth.push(OptFormatyKoloruObrazuQoi::ColorA32);
                            }
                        }
                    }
                }
